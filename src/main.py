...
async def lifespan(app: FastAPI):
    ...
    if captcha_config.captcha_method == "personal":
        try:
            ...
            print("⚠ Browser captcha (personal mode) unavailable - nodriver not installed")
            print("  Please use ezcaptcha, yescaptcha, capmonster, or capsolver instead")
        ...
        try:
            ...
            print("⚠ Browser captcha (headless mode) unavailable - playwright not installed")
            print("  Please use ezcaptcha, yescaptcha, capmonster, or capsolver instead")
